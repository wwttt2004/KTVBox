...
import com.yiqiding.ktvbox.widget.adapter.RankYqcPagerListAdapter;

/**
 * YqcRankGridListFragment.java
 * com.yiqiding.ktvbox.widget.fragment
 * KTVBox
 * Created by culm on 13-12-26
 * Copyright (c) 2013 YiQiDing Inc. All rights reserved.
 */
public class YqcRankGridListFragment extends BaseFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new RankYqcPagerListAdapter(this));
    }
    ...
    protected void initContentView() {
        ...
        al_params = new AbsoluteLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ...
                (int) (displayMetrics.heightPixels * (146.0f / 1200f)));
        viewPager.setLayoutParams(al_params);
        //bottom
        LinearLayout ll_bottom = new LinearLayout(getActivity());
        layoutParams = new AbsoluteLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        LinearLayout.LayoutParams liParams = new LinearLayout.LayoutParams((int) (displayMetrics.heightPixels
                * (8.0 / 120f) * (7f / 8.0f)),
                (int) (displayMetrics.heightPixels * (8.0 / 120f)));
        liParams.gravity = Gravity.CENTER_VERTICAL;
        liParams.leftMargin = (int) (displayMetrics.widthPixels * (28.0 / 70f));
