...
import com.yiqiding.ktvbox.widget.adapter.PopSangListAdapter;
...
/**
 * PopupWindowSangSongsActivity.java
 * com.yiqiding.ktvbox.view
 * <p/>
 * Created by culm on 13-12-4.
 * Copyright (c) 2013 YiQiDing Inc. All rights reserved.
 */
public class PopupWindowSangSongsActivity extends BaseActivity{
    private @ViewInject(id=android.R.id.list)
    ListView listView;
    private
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.popup_sang_song_fragment);
        init();
    }
    private void init() {
    ...
    public void loadDataByIndex(int i) {
        ...
        pageIndex = i;
        PopSangListAdapter adapter = new PopSangListAdapter(this, list_curr_data);
